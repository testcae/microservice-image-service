...
public class postimageTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(postimage.class.getCanonicalName(),"0.1");
  ...
  public void testpostimage() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("POST", mainPath + "/post", image.toJSONString(),
